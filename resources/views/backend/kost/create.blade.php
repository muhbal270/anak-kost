@extends ('backend.layouts.app', ['title' => 'Tambah Data Kost'])
        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" action="{{ route('admin.kost.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="kota_id" id="kota_id" class="form-select" aria-label="Default select example">
                                                <option selected>-- Pilih Kota --</option>
                                                @foreach ($kotas as $item)
                                                    <option value="{{ $item->id }}" {{ old('kota_id') == $item->id ? 'selected' : '' }}>{{ $item->nama_kota }}</option>
                                                @endforeach
                                            </select>
                                            @error('kota_id')
                                                <div class="text-danger">
